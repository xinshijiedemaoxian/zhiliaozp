#datescroll div{float: left;margin-top: 15px;text-align: center;}
#datescroll_datetime div{float: left;margin-left: 10%;padding-right: 22px;}
#yearwrapper{position: absolute;left: 0;top:45px;bottom: 60px;width:50%;}
#monthwrapper{position: absolute;left: 50%;top:45px;bottom: 60px;width:50%;}
#daywrapper{display:none;position: absolute;left: 50%;top:45px;bottom: 60px;width:80%;}
...
#dateconfirm{position: absolute;background:#00baff;left:20px;color:#fff;}
#datecancle{position: absolute;background:  #dcdddd;right:20px;width: 40%;color:#666;}
#dateshadow{display: none;position: absolute;width: 100%;height: 100%;top:0;left:0;background: #2b2b2b; filter:alpha(Opacity=50);-moz-opacity:0.5;opacity: 0.5;z-index: 1050;}
#datePage{font-size: 22px; border-radius: 3px; position:absolute;bottom:0;margin-right: auto;vertical-align:middle;
margin-left: auto;width: 100%;;height: 240px;background: #FFFFFF;z-index:9999999;}
#datetitle{width: 100%;height:50px;background: #00baff;text-align: center;color: #fff;line-height: 50px;font-size: 20px;font-family:'microsoft yahei';}
#datetitle h1{font-weight:normal;line-height: 50px;font-size:2.4rem;}
#datemark{font-size: 18px;left:5%;width: 90%;height: 20px;position:absolute;top:108px;background:#eee;border:1px solid #eee;}
#timemark{font-size: 18px;left:5%;width: 90%;height: 20px;position:absolute;bottom:0px;background:#eee;border:1px solid #eee;}
...
#yearwrapper ul,#monthwrapper ul,#daywrapper ul{width:100%;}
